...
LICENSE NOTES
=============
The included  ENet network library which Sauerbraten uses is covered by an
MIT-style license, which is however compatible with the above license for
...
For additional authors/contributors, see the Sauerbraten binary distribution
readme.
