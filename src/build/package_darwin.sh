...
if [ $UNIVERSAL -eq 1 ]; then
    ...
    X32PKG="${PTMP}/wc-ng-sdl2-v${version}_darwin_i386${SUFFIX}.tar.bz2"
    X64PKG="${PTMP}/wc-ng-sdl2-v${version}_darwin_x86_64${SUFFIX}.tar.bz2"
    ...
    PKGNAME="wc-ng-sdl2-v${version}_${PLATFORM}"
