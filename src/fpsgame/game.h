...
struct fpsent : dynent, fpsstate
{
    ...
    string name, origname, team, info; //NEW added origname
    int playermodel;
    ai::aiinfo *ai;
    ...
    {
        name[0] = origname[0] = team[0] = info[0] = 0; //NEW added origname
        //NEW
#ifndef STANDALONE
        extinfo = NULL;
#endif //STANDALONE
...
namespace game
{
    ...
    extern int statuscolor(int privilege, int state, int color); //NEW
